...
def main():
    ...
    parser.add_argument("--arch", type=str, default="mlp", choices=["mlp", "gnn", "attention"], help="Model architecture: mlp or gnn/attention")
    ...
    parser.add_argument("--scheduler", type=str, default="cosine", choices=["cosine", "plateau"], help="LR scheduler: cosine annealing (recommended) or plateau reduction")
